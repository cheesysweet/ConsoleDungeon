...
/**
 * FocusedShot ability used by Warrior, SkeletonWarrior and Lich Lord.
...
public class Whirlwind extends BaseAbility implements Constants{
    ...
    public boolean execute(int dmg, boolean target){
        return performAbility("%s (-%d AP, -%d Energy)".formatted(this.toString(),this.getActionPointCost(),
                this.getEnergyCost()), this.getAmountOfTargets(), dmg, target);
    }
    ...
    public String toString(){
        return Constants.ABILITY_WHIRLWIND;
    }
}
